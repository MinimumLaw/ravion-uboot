/*
 *
 * Configuation settings for a Toradex Colibri XScale PXA300 module on a
...
#define CONFIG_PXA300			/* XScale PXA300 */
#define CONFIG_COLIBRI_PXA300V11 1	/* Toradex Colibri XScale PXA300 */
...
#define CONFIG_SYS_USB_OHCI_SLOT_NAME	"colibri_pxa300"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"defargs=console=ttyS0,115200n8 mem=64M\0"   \
	"flashboot=console=ttyS0,115200n8 ip=off mem=64M root=/dev/mtdblock5 rw rootfstype=yaffs2\0" \
...
#define CONFIG_SYS_MONAHANS_RUN_MODE_OSC_RATIO		8 /* valid values: 8,
							     16, 24, 31 */
 ...
 */
#define CONFIG_SYS_NAND_U_BOOT_DST	0x83008000	/* Load NUB to this
							   addr */
