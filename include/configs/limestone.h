/*
 *
 * Configuation settings for the Toradex Limestone PDA Design Kit V1.2.
 *
...
#define CONFIG_LIMESTONE	1	/* Toradex Limestone */
...
#define CONFIG_SYS_USB_OHCI_SLOT_NAME	"limestone"
...
#define MTDIDS_DEFAULT		"nand0=limestone-nand"
#define MTDPARTS_DEFAULT	"mtdparts=limestone-nand:"		\
