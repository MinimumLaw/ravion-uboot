 ...
 *
 * U-Boot Integration (C) Copyright 2010
...
/* Samsung K9K8G08U0A, K9K8G08U0B and K9K8G08U0D on Toradex Colibri XScale
   PXA320 V1.2d, V1.2e, V1.2f, V2.0a, V2.0b, Colibri XScale PXA320 IT V1.2b,
   V1.2c, V2.0a, V2.0b, Limestone PDA V1.2b and V2.0c */
...
static struct pxa3xx_nand_timing samsung4GbX8_timing = {
	.tCH	= 5,		/* CE# hold time */
	.tCS	= 20,		/* CE# setup time */
	.tWH	= 10,		/* WE# high hold time */
	.tWP	= 20,		/* WE# pulse width (12 ns is too short!) */
	.tRH	= 100,		/* tRHZ, ND_nRE high duration */
	.tRP	= 12,		/* RE# pulse width */
	.tR	= 25000,	/* Data Transfer from Cell to Register */
	.tWHR	= 60,		/* WE# high to RE# low */
	.tAR	= 10,		/* ALE to RE# delay */
};
...
static struct pxa3xx_nand_flash samsung1GbX8 = {
	...
	.flash_width	= 8,		/* Width of Flash memory */
	.dfc_width	= 8,		/* Width of flash controller */
	.num_blocks	= 1024,		/* Number of physical blocks in
					   Flash */
	.chip_id	= 0xf1ec,	/* chip ID, vendor ID */
};
...
static struct pxa3xx_nand_timing micron_timing = {
	.tCH	= 10,		/* CE# hold time */
	.tCS	= 25,		/* CE# setup time */
	.tWH	= 15,		/* WE# pulse width high */
	.tWP	= 25,		/* WE# pulse width */
	.tRH	= 15,		/* tREH, RE# high hold time */
	.tRP	= 25,		/* tRP, RP# pulse width (25 ns) */
	.tR	= 25000,	/* Data transfer from Flash array to data register */
	.tWHR	= 60,		/* tWHR, WE# high to RE# low (80 ns) */
	.tAR	= 10,		/* ALE to RE# delay */
};
