...
enum {
	...
	MX51_PAD_UART1_RXD__UART1_RXD_DTE	= IOMUX_PAD(0x618, 0x228, 0, 0x9e4, 1, MX51_UART_PAD_CTRL),
	...
	MX51_PAD_UART1_RTS__UART1_RTS_DTE	= IOMUX_PAD(0x620, 0x230, 0, 0x9e0, 1, MX51_UART_PAD_CTRL),
